return {
    ...
    -- stylua: ignore
    keys = {
      { "<leader><space>", require("utils").find_files, desc = "Files" },
      { "<leader>jf", require("utils").find_files, desc = "Find Fles" },
      { "<leader>jo", "<cmd>Telescope frecency theme=dropdown previewer=false<cr>", desc = "Recent" },
      { "<leader>jb", "<cmd>Telescope buffers<cr>", desc = "Buffers" },
      { "<leader>jr", "<cmd>Telescope file_browser<cr>", desc = "File Browser" },
      ...
      { "<leader>sf", "<cmd>Telescope live_grep<cr>", desc = "Files" },
      { "<leader>sh", "<cmd>Telescope help_tags<cr>", desc = "Search" },
